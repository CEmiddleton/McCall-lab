...
# Load your data
csv_file_path <- "C:/Users/caitl/OneDrive/Desktop/Toxoplasma/RF analysis/spearman correlations redo/liver 15/varImp_rffit_liver_features_WT_15_INF_UNINF.csv"
...
# Load features data
features <- read.csv("C:/Users/caitl/OneDrive/Desktop/Toxoplasma/RF analysis/spearman correlations redo/liver 15/liver_15.csv")
head(features)
...
write.csv(correlation_df, "RF_output_correlated_to_combined_kynurenine_Liver_15_redone.csv", row.names = FALSE)
