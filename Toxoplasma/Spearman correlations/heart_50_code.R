...
# Load your data
csv_file_path <- "C:/Users/caitl/OneDrive/Desktop/Toxoplasma/RF analysis/spearman correlations redo/heart 50/varImp_rffit_heart_features_WT_INF_UNINF_50.csv"
...
# Load features data
features <- read.csv("C:/Users/caitl/OneDrive/Desktop/Toxoplasma/RF analysis/spearman correlations redo/heart 50/heart_50.csv")
head(features)
...
write.csv(sig_by_RF_wMeta, "sig_by_RF.csv", row.names = FALSE)
...
write.csv(correlation_df, "RF_output_correlated_to_combined_kynurenine_heart_50_redone.csv", row.names = FALSE)
