...
# Load your data
csv_file_path <- "C:/Users/caitl/OneDrive/Desktop/Toxoplasma/RF analysis/spearman correlations redo/large intestine 50/varImp_rffit_Large_Intestine_features_WT_INF_UNINF_50.csv"
...
# Load features data
features <- read.csv("C:/Users/caitl/OneDrive/Desktop/Toxoplasma/RF analysis/spearman correlations redo/large intestine 50/large_intestine_50.csv")
head(features)
...
write.csv(correlation_df, "RF_output_correlated_to_combined_LI_50_redone.csv", row.names = FALSE)
