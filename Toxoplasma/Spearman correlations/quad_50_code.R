...
# Load your data
csv_file_path <- "C:/Users/caitl/OneDrive/Desktop/Toxoplasma/RF analysis/spearman correlations redo/quad 50/varImp_rffit_quad_features_WT_INF_UNINF_50.csv"
...
# Load features data
features <- read.csv("C:/Users/caitl/OneDrive/Desktop/Toxoplasma/RF analysis/spearman correlations redo/quad 50/quad_50.csv")
head(features)
...
write.csv(correlation_df, "RF_output_correlated_to_combined_kynurenine_quad_50_redone.csv", row.names = FALSE)
